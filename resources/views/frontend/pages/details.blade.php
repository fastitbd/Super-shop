            ...
            <div class="container my-4">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12 mb-3 text-center">
                        <img style="width:40%;" src="{{ asset("uploads/products/" . $product->images) }}"
                            class="img-fluid mt-3" alt="Shero Biscuit">
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="Product_right border p-3 rounded shadow-sm">
                            ...
                            <h4 class="details_price">৳{{ $product->selling_price }} <span>{{ $product->unit->name }}</span>
                            </h4>
            ...
            <div class="container ">
                <div class="details_discription_item my-4">
                    ...
                    <ul class="nav nav-tabs" id="productTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#reviews"
                    ...
                    <div class="tab-content p-3 border border-top-0" id="productTabContent">
                        ...
                        <div class="tab-pane fade show active" id="description" role="tabpanel">
                            ...
                            <p><strong>Net weight:</strong> {{ $product->weight ?? 'No Weight' }}</p>
                            <p><strong>Product type:</strong> {{ $product->subcategory->name ?? 'No Subcategory' }}</p>
                            <p class="text-warning mt-4 mb-1 fw-bold">Return/cancellation:</p>
                            <p class="text-warning">
                                No change will be applicable which are already delivered to customer. If product quality or
                                quantity problem found then customer can return/cancel their order on delivery time with
                                presence of delivery person.
                            </p>

                            <p class="text-warning mt-3 fw-bold">Note:</p>
                            <p class="text-warning">Product delivery duration may vary due to product availability in stock.
                            </p>
                        </div>
