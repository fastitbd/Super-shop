...
@section('content')
                            ...
                            <div class="col-md-12 col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <thead>
                                                    <tr style="background: #000ce2; color: white;">
                                                        ...
                                                        <th class="variations-col">IMEI</th>
                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-12 col-md-6 offset-md-3 col-lg-4 offset-lg-7">
                                                {{-- Grand Total --}}
                                        <div class="mb-3 row">
                                            <label class="col-6 text-right fw-bold col-form-label">Total Qty:</label>
                                            <div class="col-6">
                                                <input type="number" step="any" style="min-width:100px" name="imei_qty" value="0"
                                                    class="form-control" id="total_qty" readonly>
                                            </div>
                                        </div>
                                        {{-- Grand Total --}}
                                        <div class="mb-3 row">
    ...
    <form action="{{ route('supplier.store') }}" method="POST">
        ...
        <x-add-modal title="Add Supplier" sizeClass="modal-lg">
            ...
            <x-input label="Father Name" type="text" name="father_name" placeholder="Enter Father Name"  md="6" />
            ...
            <x-input label="Reference Name" type="text" name="ref_name" placeholder="Enter reference name"  md="6" />
