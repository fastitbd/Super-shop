                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"
                                            style="border-top-left-radius: 25px;border-bottom-left-radius: 25px;background:#000ce2;color:white;"
                                            id="basic-addon1"><i class="fa fa-barcode"></i></span>
                                    </div>
                                                ...
                                                <thead>
                                                    <tr style="background: #000ce2; color: white;">
                                                        <th class="product-col"
                                                            style="border-radius: 25px 0 0 25px; padding: 10px;">Product
                                                        </th>
                                ...
                                <div class="row mt-4">
                                    <div class="col-sm-12 col-md-6 offset-md-3 col-lg-4 offset-lg-7">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6">
                                                <input type="number" step="any" name="discount_amount" min="0" value="0"
                                                    class="form-control discount_amount" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6">
                                                <input type="number" step="any" name="total_amount" min="0" value="0"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6">
                                                <input type="number" step="any" name="paid_amount" min="0" value="0"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-6">
                                                <input type="number" step="any" name="due_amount" min="0" value="0"
                                                    class="form-control due_amount text-danger" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('js')
    ...
    <script>
        ...
        $(document).on("click", ".submit_button", function () {
            ...
            //         // var total_price = parseFloat($(".total_amount").val()); 
            //         var selectedBankBalance = parseFloat($("#bankAmount").find(":selected").data("bank-balance")); // Get selected bank balance
            // console.log(total_price);
            // console.log(selectedBankBalance);

            //         if (total_price >= selectedBankBalance) {
            //             e.preventDefault(); 
            //             iziToast.warning({
            //                 title: "Cannot submit!",
            //                 message: "Please deposit enough balance.",
            //                 position: "topRight",
            //             });
            //         }
            //     });
        ...
        $(document).ready(function () {
            $("#purchaseForm").on("submit", function (e) {
                var total_price = parseFloat($(".total_paid").val());
                var selectedBankBalance = parseFloat($("#bankAmount").find(":selected").data("bank-balance"));
