...
@section('section-title', 'Product Variation')
@section('page-title', 'Product Variation List')
...
@section('content')
                        ...
                        <table id="datatable-buttons" class="table table-striped text-center">
                            <thead class="header_bg">
                                <tr>
                                    ...
                                    <th>Color Name</th>
                                    <th class="header_style_right">Size Name</th>
                            ...
                            <tbody>
                                @forelse($variations as $data)
                                    <tr>
                                        ...
                                        <td class="table_data_style_right">{{ $data->size->size }}</td>
    ...
    <form action="{{ route('color.store') }}" method="POST">
        ...
        <x-add-modal title="Add Color" sizeClass="modal-lg">
            <x-input label="Color Name *" type="text" name="color_name" placeholder="Enter Color Name" required />
        </x-add-modal>
    </form>
