...
@if (check_permission('banner.store'))
                                ...
                                @forelse($allbanner as $data)
                                    ...
                                    <tr>
                                        ...
                                        <td class="cat_image" style="width: 60px;">
                                            <img class="img-fluid" src="{{ asset('uploads/banner/' . $data->images) }}" alt="">
                                        </td>
                                        <td class="table_data_style_right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    @if (check_permission('banner.update'))
                                                    ...
                                                    {{-- delete --}}
                                                    @if (check_permission('banner.destroy'))
                                                        @if ($count_cat < 1)
