...
@section('page-title', 'OwnerShip Ledger')
                ...
                <form action="#">
                  ...
                  <div class="form-row mt-2">
                    <div class="form-group col-12">
                        ...
                        <a href="{{ route('ownership.index') }}" class="btn add_list_btn_reset">Reset</a>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <div class="invoice-header">
                      <div class="logo-area">
                        <img src="{{ (!empty(get_setting('system_logo')))?url('public/public/uploads/logo/'.get_setting('system_logo')):url('public/backend/images/logo.png') }}" class="img-fluid" alt="logo">
                      </div>
                      <table class="table">
                        <tbody>
                            <tr>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        @endphp
                        <tr>
                          <td class="table_data_style_left">{{ date('Y-m-d', strtotime($data->date)) }}</td>
                          <td>
                          ...
                          <td>{{ $data->debit }}</td>
                          <td>{{ $data->credit }}</td>
                          <td class="table_data_style_right">{{ $balance >= 0 ? number_format($balance,2) : '('.number_format(abs($balance), 2).')' }}</td>
                        </tr>
                        @empty
                            <tr>
