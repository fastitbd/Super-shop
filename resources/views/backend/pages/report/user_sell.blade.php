                ...
                <form action="{{ route('report.user.sell') }}">
                  ...
                  <div class="form-row mt-2">
                    <div class="form-group col-12">
                        ...
                        <a href="{{ route('report.user.sell') }}" class="btn add_list_btn_reset">Reset</a>
                    ...
                    <div class="table-responsive">
                        ...
                        <tfooter>
                            <tr class="header_bg" style=" font-size: 20px; font-width: 700; font-family:sans-serif">
                                ...
                                <td class="header_style_right" colspan="2"><strong> {{number_format($sub_total,2)}} {{ empty(get_setting('com_currency')) ? : get_setting('com_currency') }} </strong></td>
                            </tr>
                        </tfooter>
                        </table>
                        @else
