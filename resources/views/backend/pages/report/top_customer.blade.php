...
@section('section-title', 'Top Customers')
@section('page-title', 'Top Customer Report')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-body card_style mb-2" style="margin-top: -5px;" id="h-hide">
                <form action="{{ route('report.reports.customers') }}">
                    <div class="form-row">
                    ...
                    <div class="form-row mt-2">
                        <div class="form-group col-12">
                            ...
                            <a href="{{ route('report.reports.customers') }}" class="btn add_list_btn_reset">Reset</a>
            ...
            <div class="card m-b-30 print_area card_style">
                <div class="card-header">
                    <h4 style="text-align: center; font-weight:bold; margin-top:25px;font-size:30px">Top Customer Report ({{ (isset($sdate))?date('m-d-Y', strtotime($sdate)):''; }} - {{ (isset($edate))?date('m-d-Y', strtotime($edate)):''; }})</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr class="header_bg">
                                ...
                                <th>Sub Total</th>
                                <th>Discount</th> --}}
                                <th class="header_style_right">Total Invoices</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            <tr>
                                ...
                                <td class="table_data_style_right">{{ $data->total_invoices }}</td>
                            </tr>
                            @empty
                                <tr>
