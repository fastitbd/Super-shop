        ...
        <div class="col-lg-12">
                ...
                <form action="{{ route('report.purchase') }}">
                  ...
                  <div class="form-row mt-2">
                    <div class="form-group col-12">
                        ...
                        <a href="{{ route('report.purchase') }}" class="btn add_list_btn_reset">Reset</a>
            ...
            <div class="card m-b-30 print_area card_style">
                <div class="card-header">
                    <h4 style="text-align: center; font-weight:bold; margin-top:25px;font-size:30px">Purchase Report ({{ (isset($sdate))?date('m-d-Y', strtotime($sdate)):''; }} - {{ (isset($edate))?date('m-d-Y', strtotime($edate)):''; }})</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr class="header_bg">
                                ...
                                <th>Quantity</th>
                                <th>Unit Price</th>
                                <th class="header_style_right">Sub Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            @php
                            ...
                            <tr>
                                ...
                                <td>{{ $qty }}</td>
                                <td>{{ number_format($data->rate, 2) }} {{ empty(get_setting('com_currency')) ? : get_setting('com_currency') }}</td>
                                <td class="table_data_style_right">{{ number_format($data->subtotal, 2) }} {{ empty(get_setting('com_currency')) ? : get_setting('com_currency') }}</td>
                            </tr>
                            @empty
                                <tr>
                        ...
                        <tfooter>
                            <tr class="header_bg" style="font-size: 20px; font-width: 700; font-family:sans-serif">
                                <td class="header_style_left" colspan="5"></td>
                                <td> <strong class="text-white"> Total Price: </strong></td>
