                            ...
                            <div class="cart-head">
                                            ...
                                            <tr class="bg-light-primary">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control discount_amount"
                                                        name="discount_amount" placeholder="0%" value="{{ ($item->invoice->discount == 0.00)? '0': $item->invoice->discount }}">
                                ...
                                <footer class="footerpos">
                                    <div class="footerpos_left">
                                        ...
                                        <input type="hidden" name="total_paid" id="" value="{{$item->invoice->total_paid}}">
