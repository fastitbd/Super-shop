                ...
                <div class="row justify-content-center">
                    <div class="col-md-7 card card-body print">
                        <div id="print-area">
                            ...
                            <div class="invoice-header row">
                                ...
                                <div class="invoice col-4 text-center">
                                    <div class="invoice-content">
                                        <h3 class="mt-3 text-black">INVOICE</h3>
                                    </div>
                                    <p>INVOICE NO</p>
                            ...
                            <hr>
                            <table class="table table-bordered table-plist my-3 order-details text-black">
                                <tr>
                                    <th><span class="th_color">#SL</span></th>
                                    <th><span class="th_color">Product</span></th>
                                    <th><span class="th_color">Quantity</span></th>
                                    <th><span class="th_color">Unit Price</span></th>
                                    <th><span class="th_color">Total Amount</span></th>
                                </tr>
