                ...
                <div class="col-md-7 card card-body print">
                    <div id="print-area">
                        <div class="invoice-header row">
                            <div class="logo_n_name col-3">
                                    <img src="{{ (!empty(get_setting('system_logo')))?url('public/uploads/logo/'.get_setting('system_logo')):url('public/backend/images/logo.png') }}" style="width: 150px; height: 50px;" alt="logo">
                                    
                            </div>
                            <address class="col-9">
                                <h2 style="font-weight: bold; margin-bottom:0">{{ (empty(get_setting('com_name'))?'----':get_setting('com_name')) }}</h2>
                                Address : {{ (empty(get_setting('com_phone'))?'----':get_setting('com_address')) }} <br> Phone : {{ (empty(get_setting('com_phone'))?'----':get_setting('com_phone')) }} Email : {{ (empty(get_setting('com_email'))?'----':get_setting('com_email')) }} <br />
                            </address>
                        </div>
                        <hr>
                        <div class="invoice-header row">
                        ...
                        <table class="table table-bordered table-plist my-3 order-details">
                            ...
                            <tr>
                                <td colspan="2" class="rm-b-l rm-b-t rm-b-b"></td>
                                <td class="text-right">Return Money : </td>
                                <td>
                                    <strong>{{ $invoice->change_amount }} </strong>{{ empty(get_setting('com_currency')) ? : get_setting('com_currency') }}
                                </td>
                            </tr>
                            @endif 
                        </table>
