                    ...
                    <form class="needs-validation" action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea class="form-control" id="validationCustom08" rows="5" placeholder="Enter User Address" name="address" required></textarea>
                            </div>
                            {{-- Image --}}
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6" style="padding-left: 100px !important">
                                <img id="showImage" style="max-width: 100px; max-height: 100px;" src="{{ asset('public/backend/images/users/profile.svg') }}" alt="your image" />
                            </div>
                        </div>
                        <hr>
